                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input name="name" id="name" type="text"
                                            placeholder="Enter your name" min="5" required>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input name="email" type="email" id="email"
                                            placeholder="Enter email address" required min="7">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input id="phone" name="phone" type="number"
                                            placeholder="Enter your phone" required min="11" max="11">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group message">
                                        <label>your message<span>*</span></label>
                                        <textarea name="message" id="message" cols="30" rows="9" placeholder="Enter Message" required></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
